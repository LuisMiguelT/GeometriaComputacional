...
\newcommand{\polar}[1]{#1^{\bigtriangleup}}
\newcommand{\doblepolar}[1]{#1^{\bigtriangleup\bigtriangleup}}
...
\noindent\textbf{Propiedades de las caras de un polítopo}
...
% \noindent\textbf{Ejercicios en polymake}
% \begin{exerciselist}
%   \item Sea $P$ el polítopo en $\mathbb{R}^4$ definido por $P=\conv{V}+\cone{Y}$, con
%   \item 
% \end{exerciselist}

\noindent\textbf{Polaridad}
\begin{exerciselist}
  \item Sean $P$ y $Q$ dos conjuntos en $\mathbb{R}^d$. Demostrar que si $P \subseteq Q$, 
  entonces $\polar{Q} \subseteq \polar{P}$, y $\doblepolar{P} \subseteq \doblepolar{Q}$.

  \item Sea $P \subset \mathbb{R}^d$. Demostrar que $P \subseteq \doblepolar{P}$.

  \item Sea $P \subset \mathbb{R}^d$. Demostrar que $\polar{P}$ es un conjunto convexo 
  y que $0 \in \polar{P}$.

  \item Demostrar que si $P$ es un polítopo y $0 \in P$, entonces $\doblepolar{P} = P$.
\end{exerciselist}
